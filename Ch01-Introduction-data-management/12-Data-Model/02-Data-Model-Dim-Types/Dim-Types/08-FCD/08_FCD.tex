...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Fast Changing Dimension}
	\begin{itemize}[<+->]
		\item How to implement FCD? \underline{{\footnotesize \textit{Hint: Search for the mini-dimension  relation table.}}}
		\begin{itemize}
			\item
			\item
			\item
...
\end{table}
\input{Ch01-Introduction-data-management/12-Data-Model/02-Data-Model-Dim-Types/Dim-Types/08-FCD/Figures/Fig_Mini_DIM_Ex.tex}
\end{frame}
