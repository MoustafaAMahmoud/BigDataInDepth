...
\begin{itemize}
	...
	\item  Requirements. % or business need (It could be DWH unification).
...
\begin{itemize}
	...
	\item Segregation of this layer if it uses different storage type or multi-teams access this layer for different purpose \blue{(ex: Kafka as landing layer)} \red{NEED TO CLARIFY THIS EXAMPLE AS KAFKA IS NOT STORAGE BUT COULD BE LANDING LAYER}.
