...
\begin{frame}
	...
	\begin{itemize}[<+->]
		\item Let's answer our previous the question, What do we need to solve data challenges?
		...
		\begin{itemize}[<+->]
			...
			\item Logical Layer
					\begin{itemize}[<+->]
						...
						\item There is a performance issue in the existing reports and you need to change to model. For example, reduce the join by creating new join table (\textit{materialized view}).
			...
			\item Physical Layer
					\begin{itemize}[<+->]
						...
						\item Assume you need to change your storage/compression/structure/access technique.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{From Operational DB to DWH}
\begin{frame}
\frametitle{From Operational DB to DWH}
\begin{itemize}[<+->]
