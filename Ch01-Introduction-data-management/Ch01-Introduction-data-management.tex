...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\midTitle{Dimensions Types: Step Dimensions}
\begin{frame}
    \frametitle{Dimensions Types}
    \begin{description}[<+->]
        \item[Shrunken Rollup Dimensions] Shrunken Rollup dimensions are a subdivision of rows and columns
        of a base dimension. These kinds of dimensions are useful for developing aggregated fact tables.

        \item[Dimension-to-Dimension] Table Joins Dimensions may have references to other dimensions.
