...
\begin{itemize}
    ...
    \item<3-> Be familiar with ETL processing for (Batch/Steaming) data over distributed systems ex: Hadoop \& Spark.  \pause
    ...
    \item<8-> Understanding of the DevOps tools and function in data life-cycle. \pause
\end{itemize}
