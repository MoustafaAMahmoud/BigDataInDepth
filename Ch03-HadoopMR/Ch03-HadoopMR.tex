...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  \begin{frame}{CREATE TABLE in Hive | continued}
	\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting]
		\small
	\begin{itemize}
...
\begin{frame}[fragile]
\frametitle{CREATE TABLE in Hive | continued}	
\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting | SORTED BY]
	\small
...
\frametitle{CREATE TABLE in Hive | continued}    
\vspace{-0.5cm}
	\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting | Clustered By: Key Points]
			\begin{itemize}
...
\frametitle{CREATE TABLE in Hive | continued}    
\vspace{-0.5cm}
\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting | Clustered By: When to Use]
		\begin{itemize}
...
\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting | Sort By: Key Points]
		\begin{itemize}
...
\frametitle{CREATE TABLE in Hive | continued}    
\vspace{-0.5cm}		
\begin{tcolorbox}[colback=white,colframe=black,title= Part 9: Clustering and Sorting | Sort By: When to Use]
		\begin{itemize}
