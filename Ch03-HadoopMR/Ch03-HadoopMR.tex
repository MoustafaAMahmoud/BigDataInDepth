...
\begin{frame}{Technical components in a data lake}
	\begin{minipage}{\textwidth}
		\begin{tikzpicture}
		  ...
		  \node[anchor=west] (image) at (0,0) {\includegraphics[width=\textwidth,height=.78\textheight,keepaspectratio]{./Figures/chapter-03/datalake_table_format.png}};
...
\begin{frame}{Why Binary Format is Faster than Text Format}
  ...
  \end{table}
  \end{frame}
\subsubsection*{Hive Data Management}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Creating Tables in Hive | continued}
