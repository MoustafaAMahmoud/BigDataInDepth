...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (50,121) -- (92,121) -- (92,141) -- (50,141) -- cycle ;
	%Shape: Rectangle [id:dp32192612836678103] 
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (110,121) -- (152,121) -- (152,141) -- (110,141) -- cycle ;
	%Shape: Rectangle [id:dp972266177760866] 
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (170,121) -- (212,121) -- (212,141) -- (170,141) -- cycle ;
	...
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (310,121) -- (352,121) -- (352,140) -- (310,140) -- cycle ;
	%Shape: Rectangle [id:dp34622696632931327]   % memory box 2
	\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (310,175) -- (352,175) -- (352,195) -- (310,195) -- cycle ;
	%Shape: Rectangle [id:dp00038374666294560544] 
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (405,190) -- (447,190) -- (447,210) -- (405,210) -- cycle ;
	%Shape: Rectangle [id:dp3209647982053657] 
	\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (490,121) -- (532,121) -- (532,141) -- (490,141) -- cycle ;
	...
	\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (490,175) -- (532,175) -- (532,195) -- (490,195) -- cycle ;
	...
	% Text Node
	\draw (50,126) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
	\draw (110,126) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
	\draw (170,126) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
	\draw (310,126) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
	\draw (405,195) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
	\draw (490,126) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\tiny \textbf{Processor}}};
	% Text Node
