...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	\draw (465,20) node [draw,rectangle,fill=mauve,text width=3cm,text centered]   [anchor=north west] [inner sep=3pt]  [font=\bfseries,font=\scriptsize] [align=left] {Once the app is complete, the AM deregisters with the RM and shuts down, allowing its own container to be repurposed};
