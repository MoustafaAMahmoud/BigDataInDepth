...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	\draw (465,20) node [draw,rectangle,fill=mauve,text width=3cm,text centered]   [anchor=north west] [inner sep=3pt]  [font=\bfseries,font=\scriptsize] [align=left] {The app executing within the container and provides information (progress, status etc) to its AM using application-specific protocol};
